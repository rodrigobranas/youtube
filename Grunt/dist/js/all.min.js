...
angular.module("listaTelefonica",["ngMessages","serialGenerator","ui","ngRoute"]),angular.module("listaTelefonica").config(["$routeProvider",function(a){a.when("/contatos",{templateUrl:"view/contatos.html",controller:"listaTelefonicaCtrl",resolve:{contatos:["contatosAPI",function(a){return a.getContatos()}],operadoras:["operadorasAPI",function(a){return a.getOperadoras()}]}}),a.when("/novoContato",{templateUrl:"view/novoContato.html",controller:"novoContatoCtrl",resolve:{operadoras:["operadorasAPI",function(a){return a.getOperadoras()}]}}),a.when("/detalhesContato/:id",{templateUrl:"view/detalhesContato.html",controller:"detalhesContatoCtrl",resolve:{contato:["contatosAPI","$route",function(a,b){return a.getContato(b.current.params.id)}]}}),a.otherwise({redirectTo:"/contatos"})}]),angular.module("listaTelefonica").config(["serialGeneratorProvider",function(a){a.setLength(5)}]),angular.module("listaTelefonica").controller("detalhesContatoCtrl",["$scope","contato",function(a,b){a.contato=b.data}]),angular.module("listaTelefonica").controller("listaTelefonicaCtrl",["$scope","contatos","operadoras","serialGenerator",function(a,b,c,d){a.app="Lista Telefonica",a.contatos=b.data,a.operadoras=c.data;var e=function(a){a.forEach(function(a){a.serial=d.generate()})};a.adicionarContato=function(b){b.serial=d.generate(),contatosAPI.saveContato(b).success(function(b){delete a.contato,a.contatoForm.$setPristine(),carregarContatos()})},a.apagarContatos=function(b){a.contatos=b.filter(function(a){return a.selecionado?void 0:a})},a.isContatoSelecionado=function(a){return a.some(function(a){return a.selecionado})},a.ordenarPor=function(b){a.criterioDeOrdenacao=b,a.direcaoDaOrdenacao=!a.direcaoDaOrdenacao},e(a.contatos)}]),angular.module("listaTelefonica").controller("novoContatoCtrl",["$scope","contatosAPI","serialGenerator","$location","operadoras",function(a,b,c,d,e){a.operadoras=e.data,a.adicionarContato=function(e){e.serial=c.generate(),b.saveContato(e).success(function(b){delete a.contato,a.contatoForm.$setPristine(),d.path("/contatos")})}}]),angular.module("listaTelefonica").directive("uiAlert",function(){return{templateUrl:"view/alert.html",replace:!0,restrict:"AE",scope:{title:"@"},transclude:!0}}),angular.module("listaTelefonica").directive("uiDate",["$filter",function(a){return{require:"ngModel",link:function(b,c,d,e){var f=function(a){return a=a.replace(/[^0-9]+/g,""),a.length>2&&(a=a.substring(0,2)+"/"+a.substring(2)),a.length>5&&(a=a.substring(0,5)+"/"+a.substring(5,9)),a};c.bind("keyup",function(){e.$setViewValue(f(e.$viewValue)),e.$render()}),e.$parsers.push(function(a){if(10===a.length){var b=a.split("/");return new Date(b[2],b[1]-1,b[0]).getTime()}}),e.$formatters.push(function(b){return a("date")(b,"dd/MM/yyyy")})}}}]),angular.module("listaTelefonica").filter("ellipsis",function(){return function(a,b){if(a.length<=b)return a;var c=a.substring(0,b||2)+"...";return c}}),angular.module("listaTelefonica").filter("name",function(){return function(a){var b=a.split(" "),c=b.map(function(a){return/(da|de)/.test(a)?a:a.charAt(0).toUpperCase()+a.substring(1).toLowerCase()});return c.join(" ")}}),angular.module("listaTelefonica").factory("contatosAPI",["$http","config",function(a,b){var c=function(){return a.get(b.baseUrl+"/contatos")},d=function(c){return a.get(b.baseUrl+"/contatos/"+c)},e=function(c){return a.post(b.baseUrl+"/contatos",c)};return{getContatos:c,getContato:d,saveContato:e}}]),angular.module("listaTelefonica").service("operadorasAPI",["$http","config",function(a,b){this.getOperadoras=function(){return a.get(b.baseUrl+"/operadoras")}}]),angular.module("listaTelefonica").value("config",{baseUrl:"http://localhost:3412"}),angular.module("serialGenerator",[]),angular.module("serialGenerator").provider("serialGenerator",function(){var a=10;this.getLength=function(){return a},this.setLength=function(b){a=b},this.$get=function(){return{generate:function(){for(var b="";b.length<a;)b+=String.fromCharCode(Math.floor(64*Math.random())+32);return b}}}}),angular.module("ui",[]),angular.module("ui").run(["$templateCache",function(a){a.put("view/accordion.html",'<div class="ui-accordion-title" ng-click="open()">{{title}}</div><div class="ui-accordion-content" ng-show="isOpened" ng-transclude></div>')}]),angular.module("ui").directive("uiAccordions",function(){return{controller:function(a,b,c){var d=[];this.registerAccordion=function(a){d.push(a)},this.closeAll=function(){d.forEach(function(a){a.isOpened=!1})}}}}),angular.module("ui").directive("uiAccordion",function(){return{templateUrl:"view/accordion.html",transclude:!0,scope:{title:"@"},require:"^uiAccordions",link:function(a,b,c,d){d.registerAccordion(a),a.open=function(){d.closeAll(),a.isOpened=!0}}}});