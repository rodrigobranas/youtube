...
angular.module("serialGenerator",[]),angular.module("serialGenerator").provider("serialGenerator",function(){var t=10;this.getLength=function(){return t},this.setLength=function(e){t=e},this.$get=function(){return{generate:function(){for(var e="";e.length<t;)e+=String.fromCharCode(Math.floor(64*Math.random())+32);return e}}}}),angular.module("ui",[]),angular.module("ui").run(["$templateCache",function(t){t.put("view/accordion.html",'<div class="ui-accordion-title" ng-click="open()">{{title}}</div><div class="ui-accordion-content" ng-show="isOpened" ng-transclude></div>')}]),angular.module("ui").directive("uiAccordions",function(){return{controller:function(t,e,o){var n=[];this.registerAccordion=function(t){n.push(t)},this.closeAll=function(){n.forEach(function(t){t.isOpened=!1})}}}}),angular.module("ui").directive("uiAccordion",function(){return{templateUrl:"view/accordion.html",transclude:!0,scope:{title:"@"},require:"^uiAccordions",link:function(t,e,o,n){n.registerAccordion(t),t.open=function(){n.closeAll(),t.isOpened=!0}}}}),angular.module("listaTelefonica",["ngMessages","serialGenerator","ui","ngRoute"]),angular.module("listaTelefonica").config(["$routeProvider",function(t){t.when("/contatos",{templateUrl:"view/contatos.html",controller:"listaTelefonicaCtrl",resolve:{contatos:["contatosAPI",function(t){return t.getContatos()}],operadoras:["operadorasAPI",function(t){return t.getOperadoras()}]}}),t.when("/novoContato",{templateUrl:"view/novoContato.html",controller:"novoContatoCtrl",resolve:{operadoras:["operadorasAPI",function(t){return t.getOperadoras()}]}}),t.when("/detalhesContato/:id",{templateUrl:"view/detalhesContato.html",controller:"detalhesContatoCtrl",resolve:{contato:["contatosAPI","$route",function(t,e){return t.getContato(e.current.params.id)}]}}),t.otherwise({redirectTo:"/contatos"})}]),angular.module("listaTelefonica").config(["serialGeneratorProvider",function(t){t.setLength(5)}]),angular.module("listaTelefonica").directive("uiAlert",function(){return{templateUrl:"view/alert.html",replace:!0,restrict:"AE",scope:{title:"@"},transclude:!0}}),angular.module("listaTelefonica").directive("uiDate",["$filter",function(t){return{require:"ngModel",link:function(e,o,n,r){var a=function(t){return t=t.replace(/[^0-9]+/g,""),t.length>2&&(t=t.substring(0,2)+"/"+t.substring(2)),t.length>5&&(t=t.substring(0,5)+"/"+t.substring(5,9)),t};o.bind("keyup",function(){r.$setViewValue(a(r.$viewValue)),r.$render()}),r.$parsers.push(function(t){if(10===t.length){var e=t.split("/");return new Date(e[2],e[1]-1,e[0]).getTime()}}),r.$formatters.push(function(e){return t("date")(e,"dd/MM/yyyy")})}}}]),angular.module("listaTelefonica").controller("detalhesContatoCtrl",["$scope","contato",function(t,e){t.contato=e.data}]),angular.module("listaTelefonica").controller("listaTelefonicaCtrl",["$scope","contatos","operadoras","serialGenerator",function(t,e,o,n){t.app="Lista Telefonica",t.contatos=e.data,t.operadoras=o.data;var r=function(t){t.forEach(function(t){t.serial=n.generate()})};t.adicionarContato=function(e){e.serial=n.generate(),contatosAPI.saveContato(e).success(function(e){delete t.contato,t.contatoForm.$setPristine(),carregarContatos()})},t.apagarContatos=function(e){t.contatos=e.filter(function(t){return t.selecionado?void 0:t})},t.isContatoSelecionado=function(t){return t.some(function(t){return t.selecionado})},t.ordenarPor=function(e){t.criterioDeOrdenacao=e,t.direcaoDaOrdenacao=!t.direcaoDaOrdenacao},r(t.contatos)}]),angular.module("listaTelefonica").controller("novoContatoCtrl",["$scope","contatosAPI","serialGenerator","$location","operadoras",function(t,e,o,n,r){t.operadoras=r.data,t.adicionarContato=function(r){r.serial=o.generate(),e.saveContato(r).success(function(e){delete t.contato,t.contatoForm.$setPristine(),n.path("/contatos")})}}]),angular.module("listaTelefonica").filter("ellipsis",function(){return function(t,e){if(t.length<=e)return t;var o=t.substring(0,e||2)+"...";return o}}),angular.module("listaTelefonica").filter("name",function(){return function(t){var e=t.split(" "),o=e.map(function(t){return/(da|de)/.test(t)?t:t.charAt(0).toUpperCase()+t.substring(1).toLowerCase()});return o.join(" ")}}),angular.module("listaTelefonica").factory("contatosAPI",["$http","config",function(t,e){var o=function(){return t.get(e.baseUrl+"/contatos")},n=function(o){return t.get(e.baseUrl+"/contatos/"+o)},r=function(o){return t.post(e.baseUrl+"/contatos",o)};return{getContatos:o,getContato:n,saveContato:r}}]),angular.module("listaTelefonica").service("operadorasAPI",["$http","config",function(t,e){this.getOperadoras=function(){return t.get(e.baseUrl+"/operadoras")}}]),angular.module("listaTelefonica").value("config",{baseUrl:"http://localhost:3412"});